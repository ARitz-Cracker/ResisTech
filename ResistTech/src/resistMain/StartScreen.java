...
public class StartScreen extends JFrame {
	...
	public StartScreen() {
		...
		JLabel lblCalculatesResistanceFrom = new JLabel("Calculates resistance from user text input (Series only)");
		lblCalculatesResistanceFrom.setHorizontalAlignment(SwingConstants.CENTER);
		lblCalculatesResistanceFrom.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/yourImageName.extension")).getImage();
		imageLabel.setIcon(new ImageIcon(img));
		imageLabel.setBounds(168, 35, 46, 14);
